            ...
            <div className="flex flex-col outline p-4 outline-gray-200 rounded-xl gap-4">
                ...
                md:items-start">
                    ...
                    md:flex-col md:items-start">
                        <img className="w-10 hover:scale-105 transition-all duration-200" src={technology.icon} alt="" />
                ...
                <button className={`${!isSelected ? " bg-black text-white cursor-pointer active:scale-95 hover:scale-105" : "bg-gray-300 text-gray-800 font-bold cursor-not-allowed"}  rounded-lg py-2 w-[97%] mx-auto
                transition-all duration-200  `}
                onClick={handleSelect} disabled={isSelected}>{!isSelected ? "Add to Stack": "✓ Added to Stack"}</button>
            </div>
        </>
    )
}
